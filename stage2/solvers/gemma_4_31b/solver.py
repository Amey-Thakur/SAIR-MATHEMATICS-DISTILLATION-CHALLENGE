...
## Your response:
Gemma models perform best with Chain-of-Thought. You MUST wrap your reasoning in <think>...</think> tags, followed by a valid markdown JSON block ```json ... ``` containing your final answer.
"""
